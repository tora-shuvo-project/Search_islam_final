...
class QuranSettingsDrawer extends StatelessWidget {
  ...
  QuranSettingsDrawer({this.suraNo});
                      ...
                      children: [
                        ...
                        DropdownButton<QareModel>(
                          items: quranProvider.qares.map((qareModel) {
                            return new DropdownMenuItem<QareModel>(value: qareModel, child: new Text(qareModel.banglaName, style: poppinsRegular));
                          }).toList(),
                          isExpanded: true,
                          underline: SizedBox.shrink(),
                      ...
                      children: [
                        ...
                        DropdownButton<KeyModel>(
                          items: quranProvider.arabyStyles.map((quranStyle) {
                            return new DropdownMenuItem<KeyModel>(value: quranStyle, child: new Text(quranStyle.keyName, style: poppinsRegular));
                          }).toList(),
                          isExpanded: true,
                          underline: SizedBox.shrink(),
