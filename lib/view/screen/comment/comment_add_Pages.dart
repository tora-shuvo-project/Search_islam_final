    ...
    if (_formKey.currentState.validate()) {
      ...
      FirestoreDatabaseHelper.addComment(commentModels).then((_) {
        setState(() {
          ...
          Navigator.of(context).push(MaterialPageRoute(builder: (context) => CommentQuestionScreen()));
        });
      });
    }
  }
                  ...
                  child: Form(
                    ...
                    child: Column(
                      children: <Widget>[
                        ...
                        TextFormField(
                          decoration: InputDecoration(labelText: 'enter your question', border: OutlineInputBorder()),
                          validator: (value) {
                            if (value.isEmpty) {
